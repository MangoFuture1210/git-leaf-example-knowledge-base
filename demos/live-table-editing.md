...
| Git Leaf surface | Project role | Review signal | Recommended mode |
| :--- | :--- | :---: | :---: |
...
column touched by the selection changes alignment, even when only some body rows are selected. Git Leaf
...
| Signal | Git Leaf meaning | Foreground | Text highlight |
| --- | --- | --- | --- |
...
Git Leaf writes native pipe-table syntax, standard Markdown emphasis, separator-row alignment, and
...
remains a separate Git Leaf extension.
